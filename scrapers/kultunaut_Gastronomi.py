...
def crawl():
    ...
    curl = f'https://www.kultunaut.dk/perl/arrlist/type-nynaut?Area=nearme&nearmeradius=2000&ArrStartdato={current_day}%2F{current_month}%20{current_year}&ArrSlutdato={final_day}%2F{final_month}%20{final_year}&Genre=Gastronomi&periode=&startnr=1'
    ...
    for i in range(1,2000,12):
        ...
        curl = f'https://www.kultunaut.dk/perl/arrlist/type-nynaut?Area=nearme&nearmeradius=2000&ArrStartdato={current_day}%2F{current_month}%20{current_year}&ArrSlutdato={final_day}%2F{final_month}%20{final_year}&Genre=Gastronomi&periode=&startnr={i}'
