...
def crawl():
    ...
    for i in range(0,999):
        ...
        data = '{"requests":[{"indexName":"scenensearchable_posts","params":"query=&maxValuesPerFacet=10&page='+i+'&highlightPreTag=__ais-highlight__&highlightPostTag=__%2Fais-highlight__&filters=post_type_label%3ATurneer&facets=%5B%22acf_venue_regions_rep%22%2C%22acf_category_name%22%5D&tagFilters=&numericFilters=%5B%22acf_plays_to_timestamp%3E%3D'+current_timestamp+'%22%2C%22acf_plays_from_timestamp%3C%3D'+past_timestamp+'%22%5D"}]}'
